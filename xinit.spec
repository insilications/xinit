...
Patch2: xinit-1.4.0-startx-current-vt.patch
Patch3: xinit-1.4.1-move-serverauthfile-into-tmp.patch
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638795509
...
%autogen --with-xterm=xfce4-terminal \
